...
new_model = tf.keras.models.load_model(r'D:\3. Imam University Research\COVID-19 RNA Analysis\Code\Code V2\COVID19VariantClassification\Classification_nucleotide_Model')



all_data_class8 = read_seq_new(r'D:\3. Imam University Research\COVID-19 RNA Analysis\Code\Code V2\COVID19VariantClassification\GeneratedSeq\SeqDecoderVAE_Nucleotides.txt',7)
...
all_data_class7 = read_seq_new(r'D:\3. Imam University Research\COVID-19 RNA Analysis\Dataset\CovidVariantsDataset\SARS-CoV-2 (B.1.525)\ncbi_dataset\data\genomic.fna',6)
